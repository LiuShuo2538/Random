...
public class Address {
    public static Object getM(Object value, Object key){
        ...
        //村区
        String[] randomName= {"修","宵","晨","戏","施","顺","祥","才","聪","银","戈","喻","声","生","铁","如","宸","誓","胜","挚","靖","齐",
                ...
                "耿","积","复","勋","佑","肃","光","轻","施","任","巧","功","玄","白","田","由","甲","申","用","目","旦","玉","丘","生","主","加","占","可","兄","石","只","叭","弘","台","叮",
                "包","卉","叫","另","古","尼","召","巨","司","句","幼","禾","札","本","丙","戊","布","卯","未","末","必","平","市","冬","孕","永","立",
                "以","央","出","北","甘","凹","凸","刊","扎","母","瓜","正","奴","奶","它","外","瓦","充","示","卡","去","失","斥","丕","乏","半","皮",
                "六","光","先","圭","戌","艮","羊","地","至","向","各","吉","名","后","舌","合","回","同","咤","臣","吋","吊","考","多","仲","伉","来",
                "企","伊","全","伍","仰","任","伙","休","价","伏","份","在","行","汀","州","丞","年","存","舟","兆","寺","竹","卉","圳","朱","朴","米",
                "朽","打","汁","次","冰","交","件","列","匠","宅","尖","老","宇","守","安","字","如","妄","亦","聿","因","夷","有","衣","羽","而","危",
                "耳","印","西","先","旭","早","百","自","旨","曲","收","乒","乓","色","此","虫","肉","妃","好","帆","亥","充","再","共","住","佃","但",
                "你","伴","佛","布","伶","夹","利","佣","余","位","伸","宋","似","作","坐","彷","畲","七","妏","妥","妞","努","妆","妘","妤","汝","妍",
                "妙","妨","妣","克","谷","告","估","君","吕","兑","束","局","托","豆","足","占","言","佑","佐","吴","吾","呈","杏","串","吹","吟","冶",
                "吸","吵","亨","伯","伺","何","含","别","刨","吧","灶","杜","町","牡","圾","赤","走","成","劫","坍","弄","坊","更","男","良","里","均",
                "壮","辰","坎","床","杆","杖","李","孚","孝","材","村","杉","杞","秀","池","汐","汕","汗","廷","江","忍","忘","志","删","形","址","见",
                "免","车","屁","身","甫","贝","旱","步","判","私","角","改","攻","即","弟","系","忙","兵","冷","宏","完","我","希","序","酉","辛","助",
                "彤","夆","八","佶","供","佰","仑","佬","佛","岱","佩","夜","欣","例","来","侏","佳","征","依","彼","侑","并","往","府","侍","使","姑",
                "姗","姒","妾","妻","始","妹","姓","妮","委","姐","姊","姆","妳","舍","和","咆","呼","咐","命","咒","或","咖","刮","咕","固","岩","冾",
                "奇","知","居","林","周","店","味","京","尚","享","昔","卓","明","朋","昏","昊","服","昆","的","帛","昌","坦","昂","旺","者","易","升",
                "昕","松","析","杵","虎","枋","杷","枇","杯","板","林","采","果","兔","枕","柑","杭","枚","东","析","采","青","炒","炊","快","忱","忽",
                "忠","念","忭","忿","杰","炎","定","宙","空","宕","穹","官","宗","宜","宛","雨","沈","沙","沁","冲","沌","汲","沐","承","汽","乳","沛",
                "函","没","汾","汴","汪","沅","沃","汶","沂","季","孟","坪","物","卦","坤","幸","社","到","坡","坻","硅","坨","岳","岸","玖","抖","扶",
                "把","批","扳","扮","扭","抑","抗","狂","乖","沉","孤","盂","氓","氛","爸","版","牧","盲","门","非","庚","冈","奉","争","决","扺","弦",
                "艾","武","协","所","抄","投","抓","抒","折","事","些","卷","劻","届","底","忝","状","竺","垧","亚","券","刷","刺","卒","卸","取","叔",
                "受","并","奔","劾","卑","其","儿","狄","典","直","延","于","卧","具","金","长","奈","两","刻","找","制","祀","祁","秉","弧","房","放",
                "斧","爬","九","勇","面","冠","军","厚","罕","俊","很","俐","侵","促","俗","系","待","信","衍","便","俘","俄","俏","律","后","侯","保",
                "亭","俬","徊","韦","侣","室","客","穿","姨","姻","娃","姜","姝","姚","咪","计","咳","哄","哈","订","却","咨","讣","哉","咱","咻","品",
                "亮","宦","科","秒","柄","柳","柏","枷","拐","柔","香","柿","染","柱","架","查","柯","柚","某","枯","柑","柒","皇","冒","昴","昧","昱",
                "音","映","宣","星","春","肖","削","前","皆","是","昨","肝","怪","性","思","怙","急","怡","怕","炫","南","炯","炬","炭","炳","怎","炮",
                ...
                "咸","省","则","相","秋","怯","砍","契","奏","巷","甚","孩","衫","酋","剉","屎","故","泵","牯","皈","杯","看","竿","轨","泰","度","拓",
                "劲","红","表","美","屏","虹","勉","勃","为","弈","狐","盆","革","扁","奕","叛","拜","建","帅","负","赴","砒","帝","界","段","研","纪",
                "既","肚","狙","剌","彦","盈","禹","约","威","羿","施","俞","眉","首","盼","贞","风","奂","飞","竑","爰","十","厝","原","冤","冥","冢",
                "准","凌","凄","座","俱","值","倪","伦","倘","倞","俩","修","倡","倩","倦","徐","径","借","倒","俶","倔","们","俾","徒","俺","倭","倚",
                "个","幸","候","倍","俸","俯","剖","剥","刚","祟","留","峪","峮","城","岛","埔","埋","高","哥","记","唇","炮","唔","哭","哽","唐","讯",
                "哲","讨","托","站","讪","讫","哨","训","员","讦","仓","哦","唈","哺","讧","宫","窈","家","案","窄","容","宬","宸","宴","宰","宵","害",
                "贡","娱","娜","姬","娘","娓","娥","娩","娣","娌","娉","娟","拾","拭","持","按","拱","拷","拮","括","挖","拿","挑","指","拯","按","耘",
                "桂","秧","栩","耕","桉","秘","租","粉","根","框","桌","栘","桑","格","桃","株","秤","秩","梳","冻","校","柴","栽","栓","料","殊","耗",
                "桔","栗","桐","秦","核","洋","洹","洸","恭","洗","洛","洪","洲","流","津","酒","洞","庭","孙","洽","汹","洵","洳","泄","娑","活","派",
                ...
                "佑","祝","珈","珀","珊","珍","玻","玳","玲","珅","差","弱","拳","砸","臭","刍","虔","蚤","衰","航","破","配","般","亳","病","马","匪",
                "狠","圃","亩","疲","笆","蚌","迅","躬","库","辱","鬼","特","展","砥","兼","钉","针","耽","只","斗","疼","翁","袁","迂","射","氧","爹",
                "豹","豺","釜","狩","奚","真","蚓","夏","益","轩","旅","财","素","扇","乘","气","畜","笑","缺","翅","效","起","巡","席","卿","师","套",
                "奘","疾","症","疹","矩","砧","蚪","衷","闪","旁","停","假","侦","偃","偌","伟","御","悠","偲","术","偶","健","偕","得","爽","偎","伪",
                "修","徘","徙","徜","做","从","侧","偏","康","庸","庾","庶","痕","匾","匿","屠","痔","麻","庹","庵","疵","剪","勒","动","执","斩","副",
                "软","务","野","邪","阡","邠","邦","那","浩","教","浪","涒","浙","涓","浚","浸","海","涕","泾","浣","涅","浦","消","浦","雪","浴","浮",
                "昆","密","崩","毕","岗","堆","培","埤","基","堂","笛","仑","羚","坚","略","堉","域","崖","崇","埴","崎","崧","崔","梓","梗","舺","梁",
                "粒","救","梯","桶","条","梨","梵","梆","斜","梧","敕","梢","械","梭","枭","杀","彪","弃","犁","杆","移","彬","梅","粗","彩","挺","捆",
                "捏","振","捉","挪","挽","挨","挟","挫","捐","捕","捍","捌","晢","够","胖","干","恿","勖","章","顶","专","将","竟","您","胄","鸟","胎",
                "悌","昼","皎","烹","眺","袒","豚","曼","尉","望","鱼","悁","胤","焉","晚","晤","悟","焊","胃","习","晟","患","晨","胥","冕","晦","曹",
                "悉","悚","敏","胞","悍","胚","悖","奢","蚵","啪","啃","啦","国","甜","念","啄","朱","袈","诀","区","欲","哑","啊","问","唯","讶","讹",
                "启","毫","设","常","商","船","许","唱","售","圈","讼","孰","盒","啤","唬","访","啡","婕","娄","婪","婀","娶","娼","婚","婢","婊","婉",
                "妇","婆","珠","珞","佩","珙","珪","琉","敖","珣","晌","班","寄","寇","窒","窕","寀","寂","宿","寅","扎","累","终","统","绊","绍","组",
                ...
                "傒","徨","备","博","街","傅","傍","贷","家","循","婿","婼","媒","婷","媚","媞","媛","堪","凯","岚","崴","尧","场","堡","嵋","诊","啼",
                "喃","喻","喊","喝","喉","证","距","注","喜","善","喨","舒","创","诉","词","残","单","喘","丧","诅","唤","彭","跑","喧","评","诃","结",
                "喇","就","诈","跌","邵","掌","措","扫","探","挣","掮","接","掉","捱","掩","掏","授","卷","采","捧","扪","掰","排","舍","掀","挂","捷",
                "棕","棵","棍","棺","植","杰","棠","栋","集","栈","椒","椅","巽","稍","程","稀","窗","棘","栖"};
...
//        String[] arrZhiXiaShi = {"北京","上海","天津"};
        ...
        java.util.HashMap<String,String[]> shengTOshi = new java.util.HashMap<>();
...
//        zhiXiaShi.put("北京",beijing);
        ...
        java.util.HashMap<String,String[]> shiTOqu = new java.util.HashMap<>();
        ...
        if (str.contains("市")) {
            ...
            hash1 = Math.abs(arrStr1[0].hashCode() + hashSalt);
            if (type == 1) {
                newStrShi = shengTOshi.get(newStrSheng)[hash1 % (shengTOshi.get(newStrSheng).length - 1)];
                type = 2;
            }else {
        ...
        if (str.contains("县")) {
            ...
            if (type==1){
                newStrShi = shengTOshi.get(newStrSheng)[hash1 % (shengTOshi.get(newStrSheng).length - 1)];
                newStrQu = shiTOqu.get(newStrShi)[hash1 % (shiTOqu.get(newStrShi).length - 1)];
                newStrShi="";
            }
            if (type==2){
                newStrQu = shiTOqu.get(newStrShi)[hash1 % (shiTOqu.get(newStrShi).length - 1)];
