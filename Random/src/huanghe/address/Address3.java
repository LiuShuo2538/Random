 ...
 * 只能清洗地址
 * 地址长度需要大于4(去除空格)
 * 特殊字符不清洗，只清汉字、数字、英文，清洗之后去除空格
 * Created by ${LiuShuo} on 2016/7/14.
 * version 3.0
 */
...
//没用上
        ...
        //不做清洗的字符串
        String[] noChange1 = {"款","初","班","饭","期","分","大","附","北","站","左","屯","坊","巷","城","省","厂","四","乡","九","院","路","县","区","园","室","镇","面","桥","堍","层","内","幢","洲","州","厦","家","楼","南","侧","店","前","部","弄","旁","组","庄","浜","十","户","中","社","荡","八","市","队","六","栋","后","五","东","号","村","右","第","苑","三","西","小","座","环","寺","一","七","二","口","委","道", "F","~","！","@","#","￥","%","…","^","……","&","*","（","）","—","—","+","}","{","：","“","》","《","？","-","(",")"
