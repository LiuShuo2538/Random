package com.wiseweb.util2;

/**
 * Created by ${LiuShuo} on 2016/6/20.
 */
public class Hunhe {
    ...
    /*  公司名 */
        ...
        if (company > 0) {
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                temp = nameArray[i];
                nameHashCode = Math.abs(temp.hashCode());//名取正数

                newCName1 += Surname[random.nextInt(nameHashCode % (Surname.length - 1))]; //获得一个固定的姓名字

            }
            if (newCName1.length() > 3) {
                String s = xingZheng[random.nextInt(xingZheng.length - 1)];
