...
public class MakeUpCompany {
     ...
     * @return
     */
    public static Object getModelCompanyName(Object value){
        ...
        for (int i=0;i<str.length();i++){
            ...
            newName += Surname[nameHashCode%(Surname.length-1)]; //获得一个固定的姓名字
        }
        return newName+"公司";
    }
    /**
     ...
     * @return
     */
    public static Object getRandomCompanyName(Object value){
    ...
    /*  公司名 */
        ...
        for (int i=0;i<str.length();i++){
            ...
            temp=nameArray[i];
            nameHashCode = Math.abs(temp.hashCode());//名取正数
            newName += Surname[random.nextInt(nameHashCode%(Surname.length-1))]; //获得一个固定的姓名字
        }
        return newName+"公司";
    }
}
