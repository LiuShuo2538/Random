 ...
 */
public class NameENameAddressFilterAlgorithm {
...
//不做清洗的字符串
        String[] noChange1 = {"街","屯", "坊", "巷", "城", "省", "厂", "乡",  "院", "路", "县", "区", "园", "室", "镇",  "层", "幢", "楼", "南", "侧", "店", "前", "部", "弄", "旁", "组", "庄", "浜", "十", "户", "中", "社", "荡", "八", "市", "队", "六", "栋", "后", "五", "东", "号", "村", "右", "第", "苑", "三", "西", "小", "座", "环", "寺", "一", "七", "二", "口", "委", "道", "F", "~", "！", "@", "#", "￥", "%", "…", "^", "……", "&", "*", "（", "）", "—", "—", "+", "}", "{", "：", "“", "》", "《", "？", "-", "(", ")", "."
        };
        String[] noChange2 = {"空空"
        };
        String[] noChange3 = {"空空空"
        };
